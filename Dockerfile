...
RUN apt-get -y update \
    && apt-get install -y build-essential cmake pkg-config libavcodec-dev libavformat-dev libswscale-dev libtbb2 libtbb-dev libjpeg-dev libpng-dev libtiff-dev libjasper-dev git-all
...
RUN sudo pip install numpy==1.11.3

RUN git clone https://github.com/opencv/opencv.git --single-branch --branch 3.3.1
